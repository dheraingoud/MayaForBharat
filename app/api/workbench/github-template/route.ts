// Source: bolt.diy/app/routes/api.github-template.ts
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const githubToken =
      process.env?.GITHUB_TOKEN || process.env.GITHUB_TOKEN || process.env.VITE_GITHUB_ACCESS_TOKEN;

    let fileList;

    // Not on Cloudflare, use zip method
