// Source: bolt.diy/app/routes/api.github-stats.ts
...
import type { GitHubUserResponse, GitHubStats } from '@/lib/workbench/types/GitHub';

async function githubStatsLoader({ request }: { request: Request }) {
  try {
...
export const GET = withSecurity(githubStatsLoader, {
  rateLimit: true,
  allowedMethods: ['GET'],
});
