// Source: bolt.diy/app/routes/api.system.diagnostics.ts
...
export async function GET(request: NextRequest) {
  ...
  const envVars = {
    hasGithubToken: Boolean(process.env.GITHUB_ACCESS_TOKEN || process.env.GITHUB_ACCESS_TOKEN),
    hasNetlifyToken: Boolean(process.env.NETLIFY_TOKEN || process.env.NETLIFY_TOKEN),
