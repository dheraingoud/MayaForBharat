// Source: bolt.diy/app/routes/api.github-branches.ts
...
export const GET = withSecurity(githubBranchesLoader);
// Remix action converted to POST handler
export const POST = withSecurity(githubBranchesLoader);
