// Source: bolt.diy/app/lib/.server/llm/constants.ts
// Ported verbatim — no import changes needed
...
export function isReasoningModel(modelName: string): boolean {
  // OpenAI reasoning models (use maxCompletionTokens)
  if (/^(o1|o3|gpt-5)/i.test(modelName)) return true;
  // DeepSeek R1 and V4 use reasoning
  if (/deepseek-(r1|v4)/i.test(modelName)) return true;
  // MiniMax M3 supports reasoning
