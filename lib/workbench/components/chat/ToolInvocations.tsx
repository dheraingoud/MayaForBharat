// @ts-nocheck — file uses import.meta.hot (Vite HMR) which is runtime-valid but not type-checkable in Next.js
...
import { logger } from '@/lib/workbench/utils/logger';
import { themeStore, type Theme } from '@/lib/workbench/stores/theme';
