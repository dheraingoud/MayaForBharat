...
import { SpeechRecognitionButton } from '@/lib/workbench/components/chat/SpeechRecognition';
...
import { ColorSchemeDialog } from '@/lib/workbench/components/ui/ColorSchemeDialog';
  ...
  return (
    <div
      className={classNames(
        'relative backdrop-blur-xl p-3 rounded-xl w-full max-w-chat mx-auto z-prompt',
      )}
      style={{
        background: 'rgba(17, 17, 16, 0.88)',
        border: '1px solid rgba(255, 255, 255, 0.06)',
        boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3), 0 0 0 1px rgba(232, 96, 26, 0.04)',
      }}
    >
      <svg className={classNames(styles.PromptEffectContainer)}>
        <defs>
          ...
          >
            <stop offset="0%" stopColor="#E8601A" stopOpacity="0%"></stop>
            <stop offset="40%" stopColor="#E8601A" stopOpacity="70%"></stop>
            <stop offset="50%" stopColor="#E8601A" stopOpacity="70%"></stop>
            <stop offset="100%" stopColor="#E8601A" stopOpacity="0%"></stop>
          </linearGradient>
      ...
      <div
        className={classNames('relative border border-white/[0.06] backdrop-blur rounded-lg')}
        style={{ background: 'rgba(26, 25, 23, 0.6)' }}
      >
        <textarea
          ref={props.textareaRef}
          className={classNames(
            'w-full pl-4 pt-4 pr-16 outline-none resize-none text-[#D4D0CA] placeholder-[#4A4742] bg-transparent text-sm',
