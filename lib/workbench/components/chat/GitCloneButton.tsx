...
import { detectProjectCommands, createCommandsMessage, escapeBoltTags } from '@/lib/workbench/utils/projectCommands';
import { generateId } from '@/lib/workbench/utils/fileUtils';
import { useState } from 'react';
import { toast } from 'react-toastify';
import { LoadingOverlay } from '@/lib/workbench/components/ui/LoadingOverlay';

import { classNames } from '@/lib/workbench/utils/classNames';
import { Button } from '@/lib/workbench/components/ui/Button';
import type { IChatMetadata } from '@/lib/workbench/persistence/db';
import { X, Github, GitBranch } from 'lucide-react';

// Import the new repository selector components
import { GitHubRepositorySelector } from '@/lib/workbench/components/@settings/tabs/github/components/GitHubRepositorySelector';
import { GitLabRepositorySelector } from '@/lib/workbench/components/@settings/tabs/gitlab/components/GitLabRepositorySelector';
      ...
      if (importChat) {
        ...
        for (const filePath of filePaths) {
          ...
          try {
            ...
            skippedFiles.push(`${filePath} (error: ${e.UIMessage})`);
          }
        }
...
${escapeBoltTags(file.content)}
  ...
  return (
    <>
      ...
      {loading && <LoadingOverlay UIMessage="Please wait while we clone the repository..." />}
    </>
  );
}
