...
import { MAX_FILES, isBinaryFile, shouldIncludeFile } from '@/lib/workbench/utils/fileUtils';
import { createChatFromFolder } from '@/lib/workbench/utils/folderImport';
import { logStore } from '@/lib/workbench/stores/logs'; // Assuming logStore is imported from this location
