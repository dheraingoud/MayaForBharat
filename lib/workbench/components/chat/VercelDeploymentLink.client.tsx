  ...
  useEffect(() => {
    async function fetchProjectData() {
      ...
      try {
        ...
        const project = projects.find((p: { name: string | string[] }) => p.name.includes(`maya-${chatNumber}`));
        ...
        const fallbackResponse = await fetch(`/api/workbench/vercel-deploy?projectId=${projectId}&token=${connection.token}`, {
          method: 'GET',
        });
