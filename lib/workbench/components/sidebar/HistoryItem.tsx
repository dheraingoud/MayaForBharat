...
import { type ChatHistoryItem } from '@/lib/workbench/persistence';
import WithTooltip from '@/lib/workbench/components/ui/Tooltip';
import { useEditChatDescription } from '@/lib/workbench/hooks';
import { forwardRef, type ForwardedRef, useCallback } from 'react';
import { Checkbox } from '@/lib/workbench/components/ui/Checkbox';
