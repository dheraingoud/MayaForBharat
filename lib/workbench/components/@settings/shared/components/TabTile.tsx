...
import type { TabVisibilityConfig } from '@/lib/workbench/components/@settings/core/types';
import { TAB_LABELS, TAB_ICONS } from '@/lib/workbench/components/@settings/core/constants';
import { GlowingEffect } from '@/lib/workbench/components/ui/GlowingEffect';
