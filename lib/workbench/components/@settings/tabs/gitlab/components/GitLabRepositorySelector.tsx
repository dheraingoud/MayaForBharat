...
import { BranchSelector } from '@/lib/workbench/components/ui/BranchSelector';
import { RepositoryCard } from './RepositoryCard';
import type { GitLabProjectInfo } from '@/lib/workbench/types/GitLab';
import { useGitLabConnection } from '@/lib/workbench/hooks';
...
export function GitLabRepositorySelector({ onClone, className }: GitLabRepositorySelectorProps) {
  ...
  const fetchRepositories = async (refresh = false) => {
    ...
    try {
      const response = await fetch('/api/workbench/gitlab-projects', {
        method: 'POST',
        headers: {
