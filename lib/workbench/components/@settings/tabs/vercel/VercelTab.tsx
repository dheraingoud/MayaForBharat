...
import type { VercelUserResponse } from '@/lib/workbench/types/vercel';
import { classNames } from '@/lib/workbench/utils/classNames';
import { Button } from '@/lib/workbench/components/ui/Button';
import { ServiceHeader, ConnectionTestIndicator } from '@/lib/workbench/components/@settings/shared/service-integration';
import { useConnectionTest } from '@/lib/workbench/hooks';
import { Collapsible, CollapsibleTrigger, CollapsibleContent } from '@/lib/workbench/components/ui/Collapsible';
...
} from '@/lib/workbench/stores/vercel';
...
export default function VercelTab() {
  ...
  const {
    ...
    testEndpoint: '/api/workbench/vercel-user',
    serviceName: 'Vercel',
