...
import { PanelHeader } from '@/lib/workbench/components/ui/PanelHeader';
import { PanelHeaderButton } from '@/lib/workbench/components/ui/PanelHeaderButton';
...
import { isMobile } from '@/lib/workbench/utils/mobile';
import { FileBreadcrumb } from './FileBreadcrumb';
import { FileTree } from './FileTree';
import { DEFAULT_TERMINAL_SIZE, TerminalTabs } from './terminal/TerminalTabs';
import { workbenchStore } from '@/lib/workbench/stores/workbench';
import { Search } from './Search'; // <-- Ensure Search is imported
import { classNames } from '@/lib/workbench/utils/classNames'; // <-- Import classNames if not already present
