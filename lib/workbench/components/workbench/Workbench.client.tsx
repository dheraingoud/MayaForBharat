...
import { getLanguageFromExtension } from '@/lib/workbench/utils/getLanguageFromExtension';
import type { FileHistory } from '@/lib/workbench/types/actions';
import { DiffView } from './DiffView';
import {
  type OnChangeCallback as OnEditorChange,
  type OnScrollCallback as OnEditorScroll,
} from '@/lib/workbench/components/editor/codemirror/CodeMirrorEditor';
import { IconButton } from '@/lib/workbench/components/ui/IconButton';
import { Slider, type SliderOptions } from '@/lib/workbench/components/ui/Slider';
import { workbenchStore, type WorkbenchViewType } from '@/lib/workbench/stores/workbench';
import { classNames } from '@/lib/workbench/utils/classNames';
import { cubicEasingFn } from '@/lib/workbench/utils/easings';
import { renderLogger } from '@/lib/workbench/utils/logger';
import { EditorPanel } from './EditorPanel';
import { Preview } from './Preview';
import useViewport from '@/lib/workbench/hooks';

import { usePreviewStore } from '@/lib/workbench/stores/previews';
import { chatStore } from '@/lib/workbench/stores/chat';
import type { ElementInfo } from './Inspector';
// ExportChatButton removed — no export in workbench
// useChatHistory removed — export functionality not used in workbench
...
export const Workbench = memo(
  ({
    ...
    // exportChat removed — no export in workbench
    ...
    // Auto-show terminal when streaming/building starts
    useEffect(() => {
      if (streaming) {
