...
import type { GitHubUserResponse, GitHubRepoInfo } from '@/lib/workbench/types/GitHub';
import { logStore } from '@/lib/workbench/stores/logs';
import { chatId } from '@/lib/workbench/persistence/useChatHistory';
import { useStore } from '@nanostores/react';
import { GitHubAuthDialog } from '@/lib/workbench/components/@settings/tabs/github/components/GitHubAuthDialog';
    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from MAYA' : 'Update from MAYA',
          tree: treeData.sha,
