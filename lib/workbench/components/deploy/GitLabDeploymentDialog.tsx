...
import { getLocalStorage } from '@/lib/workbench/persistence/localStorage';
import type { GitLabUserResponse, GitLabProjectInfo } from '@/lib/workbench/types/GitLab';
import { logStore } from '@/lib/workbench/stores/logs';
import { chatId } from '@/lib/workbench/persistence/useChatHistory';
import { useStore } from '@nanostores/react';
import { GitLabApiService } from '@/lib/workbench/services/gitlabApiService';
import { SearchInput, EmptyState, StatusIndicator, Badge } from '@/lib/workbench/components/ui';
import { formatSize } from '@/lib/workbench/utils/formatSize';
import { GitLabAuthDialog } from '@/lib/workbench/components/@settings/tabs/gitlab/components/GitLabAuthDialog';
