// Source: bolt.diy/app/lib/runtime/message-parser.ts
// Ported: ~/types → @/lib/workbench/types, ~/utils → @/lib/workbench/utils
// This is the BATTLE-TESTED streaming parser for <boltArtifact>/<boltAction> tags

import type { ActionType, BoltAction, BoltActionData, FileAction, ShellAction, SupabaseAction } from '@/lib/workbench/types/actions';
import type { BoltArtifactData } from '@/lib/workbench/types/artifact';
...
export class StreamingMessageParser {
  ...
  #parseActionTag(input: string, actionOpenIndex: number, actionEndIndex: number) {
    ...
    if (actionType === 'supabase') {
      ...
      (actionAttributes as unknown as SupabaseAction).operation = operation as 'migration' | 'query';
      ...
      if (operation === 'migration') {
        ...
        (actionAttributes as unknown as SupabaseAction).filePath = filePath;
      }
      ...
      (actionAttributes as unknown as FileAction).filePath = filePath;
