import type { PromptOptions } from '@/lib/workbench/prompts/prompt-library';
...
<system_constraints>
  ...
  - WebContainer CANNOT execute diff or patch editing so always write your code in full no partial/diff update\r
  - CRITICAL: NEVER tell the user to "run" a command. The user CANNOT access a terminal.\r
