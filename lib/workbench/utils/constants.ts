// Source: bolt.diy/app/utils/constants.ts
// Ported: process.env → process.env, ~/lib → @/lib/workbench
...
export const DEFAULT_MODEL =
  (typeof process !== 'undefined' && process.env?.MAYA_FAST
    ? process.env.MAYA_FAST.replace(/^nvidia-nim\//i, '').trim()
...
// Template type definition (was in ~/types/template)
...
// NOTE: PROVIDER_LIST and DEFAULT_PROVIDER are initialized lazily in the LLM manager
// to avoid circular dependencies. Import from @/lib/workbench/llm/manager directly.
