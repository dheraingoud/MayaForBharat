...
// PROVIDER_LIST — static client-side list for settings store initialization
// These match the 22 providers in lib/workbench/llm/registry.ts
const PROVIDER_LIST = [
  ...
  { name: 'Deepseek', staticModels: [], getApiKeyLink: 'https://platform.deepseek.com/api_keys' },
  ...
  { name: 'Fireworks', staticModels: [], getApiKeyLink: 'https://fireworks.ai/account/api-keys' },
  { name: 'Cerebras', staticModels: [], getApiKeyLink: 'https://cloud.cerebras.ai/' },
  { name: 'Hyperbolic', staticModels: [], getApiKeyLink: 'https://app.hyperbolic.xyz/settings' },
  { name: 'Github', staticModels: [], getApiKeyLink: 'https://github.com/settings/tokens' },
  { name: 'AmazonBedrock', staticModels: [], getApiKeyLink: '' },
  { name: 'Moonshot', staticModels: [], getApiKeyLink: 'https://platform.moonshot.cn/console/api-keys' },
  { name: 'NvidiaNIM', staticModels: [], getApiKeyLink: 'https://build.nvidia.com/' },
  { name: 'Z-AI', staticModels: [], getApiKeyLink: '' },
  { name: 'Ollama', staticModels: [], getApiKeyLink: '' },
  { name: 'LMStudio', staticModels: [], getApiKeyLink: '' },
  { name: 'OpenAILike', staticModels: [], getApiKeyLink: '' },
];
import type { IProviderConfig } from '@/lib/workbench/types/model';
import type { TabVisibilityConfig, TabWindowConfig, UserTabConfig } from '@/lib/workbench/components/@settings/core/types';
import { DEFAULT_TAB_CONFIG } from '@/lib/workbench/components/@settings/core/constants';
...
const fetchConfiguredProviders = async (): Promise<ConfiguredProvider[]> => {
  try {
    const response = await fetch('/api/workbench/configured-providers');
