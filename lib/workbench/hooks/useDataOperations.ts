...
import { ImportExportService } from '@/lib/workbench/services/importExportService';
import { useIndexedDB } from '@/lib/workbench/hooks/useIndexedDB';
...
export function useDataOperations({
  ...
  const handleExportAPIKeys = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch('/api/workbench/export-api-keys');
