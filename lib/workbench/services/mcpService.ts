// @ts-nocheck — uses deprecated AI SDK v3 patterns (Message, formatDataStreamPart) pending full migration
import type { UIMessage } from 'ai';
import { convertToModelMessages } from 'ai';
type ToolSet = Record<string, any>;
type DataStreamWriter = any;
const experimental_createMCPClient = null as any;
// MCP stdio transport not available in browser
const Experimental_StdioMCPTransport = null as any;
